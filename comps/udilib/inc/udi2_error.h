...
enum
{
	...
	CSUDI_EXTAND_ERROR_BASE         = 31 << 16,     ///<expand外围设备模块的错误代码基本值
	CSUDI_HID_ERROR_BASE            = 32 << 16,     ///<HID模块的错误代码值 
	CSUDI_VENC_ERROR_BASE           = 33 << 16,     ///<VENC视频编码模块的错误码
	CSUDI_AENC_ERROR_BASE           = 34 << 16,     ///<AENC音频编码模块的错误码
	CSUDI_MUXER_ERROR_BASE          = 35 << 16,
