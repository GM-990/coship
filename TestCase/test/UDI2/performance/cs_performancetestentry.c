...
{
	{CS_TK_AUTOCASE(CSTC_PERFORMANCE_MT_0001)},//CS_TK_AUTOCASE,测试过程无需干预
	{CS_TK_AUTOCASE(CSTC_PERFORMANCE_MT_0002)},
	{CS_TK_AUTOCASE(CSTC_PERFORMANCE_MT_0003)},
	{CS_TK_AUTOCASE(CSTC_PERFORMANCE_MT_0004)},
	//{CS_TK_MANUALCASE(CSTC_PERFORMANCE_MT_0002)},//CS_TK_MANUALCASE，测试过程需与测试者交互
...
{
	CSPERFORMANCETESTGetObj,	//对应自己，必须是第一个，必须要有
