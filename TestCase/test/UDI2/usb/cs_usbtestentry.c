...
{
	{CS_TK_MANUALCASE(CSTC_USB_IT_GetCount_0001)},//CS_TK_AUTOCASE,测试过程无需干预
	...
	/*{CS_TK_MANUALCASE(CSTC_USB_MT_0002)},*///CS_TK_MANUALCASE，测试过程需与测试者交互
...
{
	CSUSBTESTGetObj,	//对应自己，必须是第一个，必须要有
