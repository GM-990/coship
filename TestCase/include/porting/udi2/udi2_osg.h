...
*/
CSUDI_Error_Code CSUDIOSGStretchBlit(CSUDI_HANDLE hDstSurface, const CSUDIOSGRect_S * psDstRect,
                        CSUDI_HANDLE hSrcSurface, const CSUDIOSGRect_S * psSrcRect, CSUDIOSGOpMode_E eOpMode);

CSUDI_Error_Code CSUDIOSGBlit(CSUDI_HANDLE hDstSurface, CSUDI_HANDLE hSrcSurface, const CSUDIOSGRect_S * psSrcRect, int x, int y, CSUDIOSGOpMode_E eOpMode);

CSUDI_Error_Code CSUDIOSGDrawPixel(CSUDI_HANDLE hDstSurface, int x1, int y1, unsigned int uPixel);

CSUDI_Error_Code CSUDIOSGDrawRectangle(CSUDI_HANDLE hDstSurface, const CSUDIOSGRect_S * psDstRect, unsigned int uPixel);


CSUDI_Error_Code CSUDIOSGStretchBlit(CSUDI_HANDLE hDstSurface, const CSUDIOSGRect_S * psDstRect,
                        CSUDI_HANDLE hSrcSurface, const CSUDIOSGRect_S * psSrcRect, CSUDIOSGOpMode_E eOpMode);

CSUDI_Error_Code CSUDIOSGShowImage(CSUDI_HANDLE hDstSurface, const char *url);

CSUDI_Error_Code CSUDIOSGDrawLine(CSUDI_HANDLE hDstSurface, int x1, int y1, int x2, int y2, unsigned int uPixel);
