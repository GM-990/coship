...
typedef enum {      /**< pthread_attr_t contentionscope values */
    PTHREAD_SCOPE_SYSTEM,   /**< default (mandatory) */
    PTHREAD_SCOPE_PROCESS
} eContScope;
typedef enum {      /**< pthread_attr_t inheritsched values */
    PTHREAD_EXPLICIT_SCHED,     /**< default */
    PTHREAD_INHERIT_SCHED
} eInheritSched;


typedef enum {      /**< pthread_attr_t detachstate values */
    PTHREAD_CREATE_DETACHED,    /**< default */
...
/**@brief This is used to statically initialize a pthread_mutex_t. Example:
...
/**@brief This is used to statically initialize a pthread_cond_t. Example:
...
/**
@brief Pushes a routine onto the calling thread's cleanup stack.
@param[in] routine	Points to the cleanup routine.
@param[in] arg Points to the single argument to be passed to the cleanup routine.
*/
void pthread_cleanup_push(void(*routine)(void*), void *arg);

/**
@brief Removes, and optionally executes, the routine at the top of the calling thread's cleanup stack.
@param[in] execute execute	Specifies if the popped routine will be executed.
*/
