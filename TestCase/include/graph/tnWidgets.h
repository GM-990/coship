...
struct widget
{
  ...
  int nClientID; /**<comment : The client ID, Add by jiangfeng 2008.3.20*/
  GR_BOOL enabled;
  GR_BOOL visible;
  GR_GC_ID gc;
...
typedef  enum  _TN_RETURNTYPE_E
{
	TN_RETURN_OK = 1,
	TN_RETURN_ERROR = -1,
	TN_RETURN_PARAM_ERROR = -1,
	TN_RETURN_TYPE_ERROR = -1
}TN_RETURNTYPE_E;
...
int tnSetWidgetProps(TN_WIDGET *, TN_WIDGET_PROPS *);
int tnGetWidgetProps(TN_WIDGET *, TN_WIDGET_PROPS *);
int tnAttachData(TN_WIDGET *,DATA_POINTER );
DATA_POINTER tnGetAttachedData(TN_WIDGET *);
int CheckValidParent(int,TN_WIDGET *);
void tnEndApp(int);

TN_WIDGET *GetWindowParent( TN_WIDGET *widget);


/** Add by jiangfeng 2008.3.26 */
/** Add Out surface for every componement */
/*******************    Begin   ******************************/
TN_WIDGET * CSMWCreateButton (TN_WIDGET * widget,
	      TN_WIDGET * parent,
	      int posx,
	      int posy,
	      char *caption,
...
TN_WIDGET * CSMWCreateWindow (TN_WIDGET *widget,
	      TN_WIDGET *parent,
	      int posx,
	      int posy,
	      char *caption, 
...
TN_WIDGET *CSMWCreateLabel (TN_WIDGET * widget,
	     TN_WIDGET * parent,
	     int posx,
	     int posy,
	     char *caption,
...
TN_WIDGET *CSMWCreateCheckButton (TN_WIDGET * widget,
		   TN_WIDGET * parent,
		   int posx,
		   int posy,
		   char *caption,
...
TN_WIDGET *CSMWCreateRadioButtonGroup (TN_WIDGET *widget,
				        TN_WIDGET *parent,
						int posx,
						int posy,
						char *caption,
...
TN_WIDGET *CSMWCreateRadioButton (TN_WIDGET *widget,
				   TN_WIDGET *parent,
				   int posx,
				   int posy,
				   char *caption,
...
TN_WIDGET *CSMWCreateCascadeMenu (TN_WIDGET * widget,
		 TN_WIDGET * parent,
		 int posx,
		 int posy,
		 char *caption,
...
TN_WIDGET *CSMWCreateComboBox(TN_WIDGET * widget,
	      TN_WIDGET * parent,
	      int posx,
	      int posy,
	      GR_SIZE height,
...
TN_WIDGET *CSMWCreateListBox(TN_WIDGET * widget,
	      TN_WIDGET * parent,
	      int posx,
	      int posy,
	      GR_SIZE height,
...
TN_WIDGET *CSMWCreateMenuBar (TN_WIDGET * widget,
	       TN_WIDGET * parent,
	       int posx,
	       int posy, GR_SIZE height, GR_SIZE width, GR_COLOR bgcolor);


TN_WIDGET *CSMWCreateMenuItem (TN_WIDGET * widget,
	      TN_WIDGET * parent,
	      int posx,
	      int posy,
	      char *caption,
...
TN_WIDGET *CSMWCreatePicture(TN_WIDGET * widget,
	      TN_WIDGET * parent,
	      int posx,
	      int posy,
	      char *filename,
...
TN_WIDGET *CSMWCreatePopUpMenu (TN_WIDGET * widget,
		 TN_WIDGET * parent,
		 int posx,
		 int posy,
		 char *caption,
...
TN_WIDGET *CSMWCreateScrollBar(TN_WIDGET * widget,
	      TN_WIDGET * parent,
	      int posx,
	      int posy,
	      GR_SIZE height,
...
TN_WIDGET *CSMWCreateTextBox (TN_WIDGET * widget,
	       TN_WIDGET * parent,
	       int posx,
	       int posy,
	       char *defaulttext,
...
TN_WIDGET *CSMWCreateProgressBar (TN_WIDGET * widget,
	     TN_WIDGET * parent,
	     int posx,
	     int posy,
	     GR_SIZE height,
