...
set MMCP_PLATFORM=st5105
set TARGET_OS=st20os20
set TARGET_ARCH=st40
set TARGET_CPU=c1
set PLATFORM=st5105
set CHIP_PROVIDER=st
set PLATFORM_JAVAVM=st20os20-c1

set ST20ROOT=C:\STM\ST20R2.2.1
set PATH=%PATH%;%ST20ROOT%;%ST20ROOT%\bin;C:\Stm\multicom-3.1.1\bin\winnt\ia32;%MMCP_HOME%\bin;
